...
Channels=["tauE_tauE", "tauMu_tauE","tauMu_tauMu","tauHad_tauMu","tauHad_tauE"]
...
def makePlots(channel,plots):
    for plot in plots:
        checkAndMakeDir(outDir+plot+"/")
        if (channel=="tauHad_tauMu" and (plot=="bMass" or plot=="Mvis")): 

            hist = "h_"+channel+"_"+plot+"_EG"
        else:
        ...
        Background = ROOT.THStack("Background_"+channel+"_"+plot,channel+plot)
